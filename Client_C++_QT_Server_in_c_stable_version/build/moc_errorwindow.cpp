...
#include "../ChatClient/errorwindow.h"
...
struct qt_meta_stringdata_ErrorWindow_t {
    QByteArrayData data[6];
    char stringdata[69];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ErrorWindow_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ErrorWindow_t qt_meta_stringdata_ErrorWindow = {
    {
...
QT_MOC_LITERAL(5, 55, 12)
    ...
    "ErrorWindow\0connect_slots\0\0goToPreviousMenu\0"
...
void ErrorWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->goToPreviousMenu(); break;
...
const QMetaObject ErrorWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_ErrorWindow.data,
      qt_meta_data_ErrorWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ErrorWindow.stringdata))
