...
public class javaClient {
    ...
    boolean cek = false, cek2 = false, checkState = false;
    String temp;
    int ctr;
    ...
    public boolean startCreate() {
        ...
        try {
            ...
            this.TUJUAN = "0";
            this.PENGIRIM = "0";
            this.CONTENT = "NULL";//this.username + ";" + this.password;
            this.TYPE = "NULL";
            sOut.write(STATE + "/r/n" + FLAG + "/r/n" + TUJUAN + "/r/n" + PENGIRIM + "/r/n" + TYPE + "/r/n" + CONTENT);
    ...
    public void ambilUserData() {
        try {
            this.STATE = "INCHAT";
            this.FLAG = "LIST_USER_REQ";
            this.TUJUAN = "0";
            this.PENGIRIM = this.username;
            this.CONTENT = "NULL";
            this.TYPE = "NULL";
            while ((temp = sIn.readLine()) != null) {
                if (ctr % 6 == 0 && ctr > 0 && !temp.equals("0")) {
    ...
    private void signOK() {
        try {
            this.STATE = "SIGNUP";
            this.FLAG = "AUTH_REQUEST";
            this.TUJUAN = "0";
            this.PENGIRIM = "0";
            this.CONTENT = this.username + ":" + this.password;
            this.TYPE = "AUTH";
            sOut.write(STATE + "/r/n" + FLAG + "/r/n" + TUJUAN + "/r/n" + PENGIRIM + "/r/n"
                    + TYPE + "/r/n" + CONTENT);
            temp = "";
            while ((temp = sIn.readLine()) != null) {
                if (temp.equals("SIGNUP_SUCCESS")) {
                    System.out.println("signup success, fetching online user data . . .");
                    checkState = true;
                    break;
                } else {
                    checkState = false;
